...
namespace DnsLib
{
	...
	public class DnsLite
	{
		...
		private string name;
		private ArrayList dnsServers = new ArrayList();
		...
		public DnsLite()
		{
			...
			GetNetworkParams(buffer, ref length);
			FixedInfo info = new FixedInfo(new MemoryStream(buffer));

			dnsServers.Add(((IpAddrString) info.DnsServerList[0]).IpAddress);
		}

		public void setDnsServers(params string[] dnsServers)
		{
